...
class ApplicantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create applicant" do
    assert_difference("Applicant.count") do
      post applicants_url, params: { applicant: { competition_id: @applicant.competition_id, email: @applicant.email, name: @applicant.name } }
    end
  ...
  test "should update applicant" do
    patch applicant_url(@applicant), params: { applicant: { competition_id: @applicant.competition_id, email: @applicant.email, name: @applicant.name } }
